...
-- CreateIndex
CREATE UNIQUE INDEX "cupons_vendorId_key" ON "cupons"("vendorId");
...
-- CreateIndex
CREATE UNIQUE INDEX "follows_customerId_key" ON "follows"("customerId");

-- CreateIndex
CREATE UNIQUE INDEX "follows_shopId_key" ON "follows"("shopId");
...
-- CreateIndex
CREATE UNIQUE INDEX "orders_shopId_key" ON "orders"("shopId");
...
-- AddForeignKey
ALTER TABLE "cupons" ADD CONSTRAINT "cupons_vendorId_fkey" FOREIGN KEY ("vendorId") REFERENCES "vendors"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
